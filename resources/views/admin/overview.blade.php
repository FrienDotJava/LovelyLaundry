...
<div class="p-5">
    <div class="bg-white rounded-3 border">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mt-3 mx-3 ">
            ...
            <h5 class="text-muted">Oktober 2024</h5>
        </div>
        <hr class="mx-5">
    ...
    <div class="mt-3 bg-white rounded-3 border">
        <div class="d-flex flex-column justify-content-center align-items-start mt-3 mx-3 ">
            <h1 class="fw-bold">Financial Report: Oktober 2024</h1>
            <h1 class="fw-bold">Total: <span style="color: #5FBDFF;">Rp1.743.000,00</span></h1>
        </div>
        <hr class="mx-5">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-2 gap-md-5">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <div class="card rounded-2 p-4 border border-3 border-info text-center">
                        ...
                        <hr class="my-2">
                        <p class="fw-bold fs-3">Rp315.000,00</p>
                    </div>
                </div>
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <div class="card rounded-2 p-4 border border-3 border-info text-center">
                        ...
                        <hr class="my-2">
                        <p class="fw-bold fs-3">Rp436.000,00</p>
                    </div>
                </div>
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <div class="card rounded-2 p-4 border border-3 border-info text-center">
                        ...
                        <hr class="my-2">
                        <p class="fw-bold fs-3">Rp266.000,00</p>
                    </div>
                </div>
            </div>
            <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-2 gap-md-5">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <div class="card rounded-2 p-4 border border-3 border-info text-center">
                        <h5>Dry Cleaning</h5>
                        <hr class="my-2">
                        <p class="fw-bold fs-3">Rp304.000,00</p>
                    </div>
                </div>
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <div class="card rounded-2 p-4 border border-3 border-info text-center">
                        <h5>Iron Cleaning</h5>
                        <hr class="my-2">
                        <p class="fw-bold fs-3">Rp422.000,00</p>
                    </div>
                </div>
            </div>
        </div>
